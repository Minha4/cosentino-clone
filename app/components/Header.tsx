...
export default function Header() {
  ...
  return (
    <header
      className="fixed inset-x-0 top-0 z-[100] text-white"
      onMouseLeave={() => setOpenMenu(null)}
    >
      <div className="bg-gradient-to-b from-black/30 via-black/10 to-transparent px-8 pb-8 pt-7">
        <div className="mx-auto flex w-full max-w-[1650px] items-center">

          {/* LOGO */}
          <a
            href="https://www.cosentino.com/usa/"
            className={`shrink-0 text-[20px] font-normal leading-none tracking-[-0.075em] transition-opacity duration-200 ${
              menuIsOpen ? "opacity-90" : ""
            }`}
          >
            COSENTINO
          </a>
          ...
          {/* DIVIDER */}
          <span className="mx-5 h-[18px] w-px shrink-0 bg-white/80" />
          ...
          <div className="relative shrink-0">
            <button
              ...
              className="flex items-center gap-2 text-[12px] font-normal tracking-[0.01em] transition-opacity duration-200 hover:opacity-60"
            >
              <GlobeIcon />
              <span>{country}</span>
              <Chevron />
          ...
          {/* MAIN NAV */}
          <nav className="ml-12 flex min-w-0 flex-1 items-center justify-center gap-7 whitespace-nowrap text-[12px] font-normal tracking-[0.01em]">

            <a
              href="https://www.cosentino.com/usa/colors/"
              className={`transition-opacity duration-200 ${
                menuIsOpen ? "opacity-35" : "hover:opacity-55"
              }`}
            >
              Colors
            </a>
            ...
            <button
              ...
              className={`flex items-center gap-1 transition-opacity duration-200 ${
                openMenu && openMenu !== "professionals"
                  ? "opacity-35"
                  : "hover:opacity-55"
              }`}
            >
          ...
          {/* RIGHT SIDE */}
          <div className="ml-12 flex shrink-0 items-center gap-7 whitespace-nowrap text-[12px] font-normal tracking-[0.01em]">
            <a
